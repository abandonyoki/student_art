			...
			<div class="panel panel-default">
				...
				<form id="searchForm" class="form-horizontal">
					<div class="form-group">
						...
						<label class="col-md-1 control-label" for = "teaName">姓名</label>
						<div class="col-md-2">
							<input class="form-control" type="text" name="teaName">
						</div>
						<label class="col-md-1 control-label" for = "professionId">专业名称</label>
						<div class="col-md-2">
			...
			<div class="modal-body">
				<form id="setForm" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" type="text" name = "teaName" placeholder="请输入教师姓名">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					<label class="col-sm-4 control-label" for="professionId">学院</label>
					<div class="col-sm-6">
...
var operation={
	...
	addForm:function(){
		...
		if($("#setForm").data("bootstrapValidator").isValid()){
			...
			$.post("teacher/insertTeacher", temp ,function(data) {
				var obj = eval('('+data+')');
				$("#dg").bootstrapTable("refresh");
	...
	editForm:function(){
		...
		if($("#setForm").data("bootstrapValidator").isValid()){
			var temp = getFormJson("setForm");
			$.post("teacher/updateTeacher", temp ,function(data) {
				var obj = eval('('+data+')');
				$("#dg").bootstrapTable("refresh");
				message.alert(obj.showInfo);
				$('#setForm').data('bootstrapValidator').resetForm(true);
		...
		if(rows.length == 1  ){
			bootbox.confirm({
				...
				callback:function(result){
					if(result){
						$.post("teacher/deleteTeacher", {id:rows[0].id} ,function(data) {
							var obj = eval('('+data+')');
							$("#dg").bootstrapTable("refresh");
