			...
			<div class="panel panel-default">
				...
				<form id="searchForm" class="form-horizontal">
					<div class="form-group">
						<label class="col-md-1 control-label" for = "courseName">科目名称</label>
						<div class="col-md-2">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="setForm" class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" >科目名称</label>
						<div class="col-sm-6">
							<input class="form-control" type="text" name = "courseName" placeholder="请输入科目名称">
						</div>
					</div>
					<div class="form-group">
...
var operation={
	...
	addForm:function(){
		...
		if($("#setForm").data("bootstrapValidator").isValid()){
			...
			$.post("course/insertCourse", temp ,function(data) {
				var obj = eval('('+data+')');
				$("#dg").bootstrapTable("refresh");
	...
	editForm:function(){
		...
		if($("#setForm").data("bootstrapValidator").isValid()){
			var temp = getFormJson("setForm");
			$.post("course/updateCourse.htm", temp ,function(data) {
				var obj = eval('('+data+')');
				$("#dg").bootstrapTable("refresh");
				message.alert(obj.showInfo);
				$('#setForm').data('bootstrapValidator').resetForm(true);
		...
		if(rows.length == 1  ){
			bootbox.confirm({
				...
				callback:function(result){
					if(result){
						$.post("course/deleteCourse.htm", {id:rows[0].id} ,function(data) {
							var obj = eval('('+data+')');
							$("#dg").bootstrapTable("refresh");
